//===-- PIC18F4455DebugInfo.h - Interfaces for PIC18F4455 Debug Information ============//
//
...
#ifndef PIC18F4455DBG_H
#define PIC18F4455DBG_H
...
namespace llvm {
  ...
  public:
    PIC18F4455DbgInfo(MCStreamer &os, const MCAsmInfo *T) : OS(os), MAI(T) {
      CurFile = "";
      CurLine = 0;
    ...
    void EmitAuxEntry(const std::string VarName, int Aux[], 
                      int num = PIC18F4455Dbg::AuxSize, std::string TagName = "");
    inline void EmitSymbol(std::string Name, short Class, 
                           unsigned short Type = PIC18F4455Dbg::T_NULL, 
