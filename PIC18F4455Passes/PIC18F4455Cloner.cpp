//===-- PIC18F4455Cloner.cpp - PIC18F4455 LLVM Cloner for shared functions -*- C++ -*-===//
//
...
namespace llvm {
  char PIC18F4455Cloner::ID = 0;

  ModulePass *createPIC18F4455ClonerPass() { return new PIC18F4455Cloner(); }
}
...
//
void PIC18F4455Cloner::reportError(string ErrorString) {
  errs() << "ERROR : " << ErrorString << "\n";
  exit(1);
}

void PIC18F4455Cloner::
...
// Entry point
//
bool PIC18F4455Cloner::runOnModule(Module &M) {
...
//
void PIC18F4455Cloner::markCallGraph(CallGraphNode *CGN, string StringMark) {
...
// For PIC18F4455, automatic variables of a function are emitted as globals.
...
//
void PIC18F4455Cloner::CloneAutos(Function *F) {
...
// marked as ML.
//
void PIC18F4455Cloner::cloneSharedFunctions(CallGraphNode *CGN) {
...
Function *
PIC18F4455Cloner::cloneFunction(Function *OrgF) {
   Function *ClonedF;
